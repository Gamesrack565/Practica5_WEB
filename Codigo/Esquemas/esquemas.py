...
class LibroActualizar(SQLModel):
    ...
    # Esto permite reasignar un libro a otra editorial o serie si se desea
    editorial_nombre: Optional[str] = None
    publico_objetivo_tipo: Optional[str] = None
    serie_nombre: Optional[str] = None

    # Para listas, si se envían, reemplazarán a la lista anterior
    autores_nombres: Optional[List[str]] = None
    categorias_nombres: Optional[List[str]] = None
