...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Imagenes/servicios62.png}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Imagenes/servicios63.png}
\end{figure}

Como se menciono la entidad libro es la más importante, por lo cual solo se mostara la funcion de creacion de libro:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Imagenes/creacion_libro1.png}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Imagenes/creacion_libro2.png}
\end{figure}
...
\begin{itemize}
    ...
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagenes/rutas_autores.png}
    \end{center}
    ...
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagenes/rutas_Editora.png}
    \end{center}
    ...
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagenes/rutas_publico.png}
    \end{center}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagenes/rutas_Series.png}
    \end{center}
    \item \textbf{\texttt{Rutas/categorias.py}}: Implementa el CRUD completo para \texttt{/Categorias}, similar a \texttt{editoriales.py}.
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagenes/rutas_categorias.png}
    \end{center}
    \item \textbf{\texttt{Rutas/libros.py}}: El archivo más complejo y principal de todos, maneja el CRUD completo para \texttt{/Libros} y define múltiples rutas \texttt{GET} para búsquedas específicas (por autor, categoría, serie y público objetivo).
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagenes/rutas_libros1.png}
    \end{center}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagenes/rutas_libros2.png}
    \end{center}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagenes/rutas_libros3.png}
    \end{center}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Imagenes/rutas_libros4.png}
    \end{center}
\end{itemize}
